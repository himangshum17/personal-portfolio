    ...
    <>
      ...
      <section className='h-screen grid place-content-center bg-teal-50'>
        <div className='container'>
          <div className='prose prose-a:text-teal-600 hover:prose-a:text-teal-700 prose-h1:text-xl lg:prose-h1:text-4xl'>
            <Image
              width='80'
              height='80'
            ...
            />
            <h1>
              Himangshu Mondal&apos;s portfolio website is under development,
